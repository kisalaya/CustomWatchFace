...
public class CustomWatchFaceService extends CanvasWatchFaceService {
    ...
    private static final String TAG = "CustomWatchFace";
    ...
    private class Engine extends CanvasWatchFaceService.Engine {
        ...
        public void onCreate(SurfaceHolder holder) {
            ...
            setWatchFaceStyle(
                    new WatchFaceStyle.Builder(CustomWatchFaceService.this)
        ...
        public void onSurfaceChanged(SurfaceHolder holder, int format, int width, int height) {
            ...
            Rect rightBounds =
                    new Rect(
                            ...
                            (midpointOfScreen + horizontalOffset),
                            (midpointOfScreen + sizeOfComplication/2 +sizeOfComplication));
        ...
        private void drawHands(Canvas canvas) {
            if(!mAmbient){
                canvas.drawText(mCalendar.get(Calendar.DAY_OF_MONTH)+"/" + (mCalendar.get(Calendar.MONTH) + 1), mCenterX+ mCenterX/2 ,mCenterY,mSecondHandPaint);
